...
const USER_CONFIG = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: 'wxdee9bf8a710983f7',

  // 公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: 'e226d2fbbfa0abd6f836656efa74399b',
  ...
  USERS: [
    {
      ...
      id: 'oTYJg5-MHJtlh3Ki6O1qY3CG3A-o',
      // 你想对他发送的模板消息的模板ID
      useTemplateId: 'pcMVWZAIUUN5yUL4TjCti5RpTKZhwXJcw2J5ARI8dz4',
      // 所在省份
      province: '广东',
      // 所在城市
      city: '肇庆',
